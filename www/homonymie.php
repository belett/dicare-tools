...
<p><label for="fallback">Langues utilisées pour le modèle {{Lien}}</label> :<br /><input type="text" id="fallback" name="fallback" value="'.htmlentities(page::getParameter('fallback', LANG_FALLBACK)).'" /></p>
