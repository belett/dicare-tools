...
define('PAGE_TITLE', 'Statistiques par pays');
require '../inc/header.inc.php';

echo '<h1>Statistiques par pays</h1>
<p>Le tableau ci-dessous donne, par pays de nationalité, le nombre de personnes ayant les propriétés <em>nom de famille</em> (<a href="https://www.wikidata.org/wiki/Property:P734">P734</a>) et <em>prénom</em> (<a href="https://www.wikidata.org/wiki/Property:P735">P735</a>) renseignées dans <a href="https://www.wikidata.org/">Wikidata</a>.</p>';
